...
### 2.1. Preparing a Data Analysis Plan
...
|  |
| --- |
| **Box 1**  **Data Analysis Objectives and Key Questions Example**  *Objectives of data analysis*   * To understand the childcare arrangements of pre-primary age children   *Key Questions*   * What types of childcare arrangements do households use? * What factors influence the choice of current childcare arrangements? * What challenges or disadvantages do households identify that are associated with different types of arrangements? |
...
### 2.2 Conducting the data analysis
